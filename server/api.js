...
router.post("/question", (req,res,next)=>{
	let title = req.body.title, context = req.body.context;
	let sql = "insert into questions (title, context)"
...
router.post("/comment", (req,res,next)=>{
	let questionId = req.body.questionId, comment = req.body.comment;
	let sql = "insert into comments (question_id, comment)"
			+"values ($1,$2) returning id";
